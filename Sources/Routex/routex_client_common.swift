...
#if canImport(routex_client_commonFFI)
import routex_client_commonFFI
#endif
...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_routex_client_common_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_routex_client_common_rustbuffer_free(self, $0) }
    }
}
...
public enum RoutexClientError: Swift.Error, Equatable, Hashable, Foundation.LocalizedError {
    ...
    case ServiceBlocked(userMessage: String?, code: ServiceBlockedCode?
    )
...
#if compiler(>=6)
extension RoutexClientError: Sendable {}
#endif
...
public struct FfiConverterTypeRoutexClientError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> RoutexClientError {
        ...
        case 6: return .ServiceBlocked(
            userMessage: try FfiConverterOptionString.read(from: &buf), 
            code: try FfiConverterOptionTypeServiceBlockedCode.read(from: &buf)
            )
        ...
        case 11: return .UnsupportedProduct(
            reason: try FfiConverterOptionTypeUnsupportedProductReason.read(from: &buf), 
            userMessage: try FfiConverterOptionString.read(from: &buf)
            )
        ...
        case 15: return .ProviderError(
            code: try FfiConverterOptionTypeProviderErrorCode.read(from: &buf), 
            userMessage: try FfiConverterOptionString.read(from: &buf)
            )
        case 16: return .ResponseError(
            response: try FfiConverterString.read(from: &buf)
            )
        case 17: return .NotFound
        case 18: return .InterruptError
    ...
    public static func write(_ value: RoutexClientError, into buf: inout [UInt8]) {
        ...
        case let .ServiceBlocked(userMessage,code):
            writeInt(&buf, Int32(6))
            FfiConverterOptionString.write(userMessage, into: &buf)
            FfiConverterOptionTypeServiceBlockedCode.write(code, into: &buf)
        ...
        case let .UnsupportedProduct(reason,userMessage):
            writeInt(&buf, Int32(11))
            FfiConverterOptionTypeUnsupportedProductReason.write(reason, into: &buf)
            FfiConverterOptionString.write(userMessage, into: &buf)
        ...
        case let .ProviderError(code,userMessage):
            writeInt(&buf, Int32(15))
            FfiConverterOptionTypeProviderErrorCode.write(code, into: &buf)
            FfiConverterOptionString.write(userMessage, into: &buf)
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterOptionTypeProviderErrorCode: FfiConverterRustBuffer {
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterTypeProviderErrorCode.write(value, into: &buf)
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwiftType {
        switch try readInt(&buf) as Int8 {
        case 0: return nil
        case 1: return try FfiConverterTypeProviderErrorCode.read(from: &buf)
        default: throw UniffiInternalError.unexpectedOptionalTag
        }
    }
}
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterOptionTypeServiceBlockedCode: FfiConverterRustBuffer {
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterTypeServiceBlockedCode.write(value, into: &buf)
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> SwiftType {
        switch try readInt(&buf) as Int8 {
        case 0: return nil
        case 1: return try FfiConverterTypeServiceBlockedCode.read(from: &buf)
        default: throw UniffiInternalError.unexpectedOptionalTag
        }
    }
}
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterOptionTypeUnsupportedProductReason: FfiConverterRustBuffer {
    ...
    public static func write(_ value: SwiftType, into buf: inout [UInt8]) {
        ...
        writeInt(&buf, Int8(1))
        FfiConverterTypeUnsupportedProductReason.write(value, into: &buf)
    }
...
private let initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_routex_client_common_uniffi_contract_version()
...
public func uniffiEnsureRoutexClientCommonInitialized() {
