...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_kitx_core_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_kitx_core_rustbuffer_free(self, $0) }
    }
}
...
extension CredentialsModel: Equatable, Hashable {
...
extension DialogOption: Equatable, Hashable {
...
extension Image: Equatable, Hashable {
    public static func ==(lhs: Image, rhs: Image) -> Bool {
        ...
        if lhs.hhdUcData != rhs.hhdUcData {
            return false
        }
        return true
    }
...
extension AccountStatus: Equatable, Hashable {}
...
extension DialogContext: Equatable, Hashable {}
...
extension PaymentErrorCode: Equatable, Hashable {}
...
extension SecrecyLevel: Equatable, Hashable {}
...
private let initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_kitx_core_uniffi_contract_version()
...
public func uniffiEnsureKitxCoreInitialized() {
